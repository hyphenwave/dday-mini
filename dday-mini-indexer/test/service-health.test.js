...
services.forEach(service => {
  runTest(`${service} structure`, () => {
    ...
    if (!packageJson.dependencies || !packageJson.dependencies['@world-pvp/shared']) {
      throw new Error(`Missing @world-pvp/shared dependency`);
    }
  });
});
...
runTest('Configuration system', () => {
  ...
  delete require.cache[require.resolve('../packages/shared/dist/config/index.js')];
